    ...
    <>
      <div className="max-w-[1280px] mx-auto " >
        ...
        <div className="my-24 ">
          <div className="grid grid-cols-1 justify-items-center  md:flex md:justify-between ">
            ...
            <div className="w-11/12 order-2 md:order-1 grid grid-cols-1 gap-8 md:gap-0  md:mt-6  md:w-6/12  ">
              ...
              <h1 className="text-[#FFEFD5] text-[16px] md:text-[19px] font-bold leading-loose  ">یه فضای ساده و دنج برای وقت‌هایی که می‌خوای از شلوغی روز فاصله بگیری.
        ...
        <div id="about" className="flex justify-center  items-center my-32 mx-4 md:mx-0 md:my-40 ">
          ...
          <div className="bg-[#2B1D0E]/85 text-[#FFF7ED] p-4 md:p-10 text-center leading-10 rounded-3xl md:w-1/2 grid grid-cols-1 gap-2">
        ...
        <div className='grid grid-cols-1 gap-28 justify-items-center md:flex md:justify-between my-40'>
          <div className='grid grid-cols-1 justify-items-center md:justify-items-start gap-6 md:gap-0 mx-4 md:mx-0 md:w-1/3'>
            ...
            <h3 className='text-[#FFF7ED]/70 font-semibold text-lg text-center md:text-start'>از منوی متنوع و خوش‌طعم ما دیدن کنید؛ نوشیدنی‌ها و خوراکی‌هایی که با عشق و دقت تهیه شده‌اند تا لحظه‌های شما خاص‌تر شوند.</h3>
            <Link href="/menu">
